...
// </auto-generated>
// Created via this command line: "C:\Users\stefa\AppData\Roaming\MscrmTools\XrmToolBox\Plugins\DLaB.EarlyBoundGenerator\crmsvcutil.exe" /url:"https://dev-thorndontech.api.crm6.dynamics.com" /namespace:"MsalUserInteractiveEarlyBoundSample.Core.Dataverse" /SuppressGeneratedCodeAttribute /out:"C:\DataverseConnectionSamples\C#\ConsoleApp\MsalUserInteractiveEarlyBoundSample.Core.Core\MsalUserInteractiveEarlyBoundSample.Core.Core\Tables\DataverseContext.cs" /servicecontextname:"DataverseContext" /codecustomization:"DLaB.CrmSvcUtilExtensions.Entity.CustomizeCodeDomService,DLaB.CrmSvcUtilExtensions" /codegenerationservice:"DLaB.CrmSvcUtilExtensions.Entity.CustomCodeGenerationService,DLaB.CrmSvcUtilExtensions" /codewriterfilter:"DLaB.CrmSvcUtilExtensions.Entity.CodeWriterFilterService,DLaB.CrmSvcUtilExtensions" /namingservice:"DLaB.CrmSvcUtilExtensions.NamingService,DLaB.CrmSvcUtilExtensions" /metadataproviderservice:"DLaB.CrmSvcUtilExtensions.Entity.MetadataProviderService,DLaB.CrmSvcUtilExtensions" 
//------------------------------------------------------------------------------
...
namespace MsalUserInteractiveEarlyBoundSample.Core.Dataverse
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="MsalUserInteractiveEarlyBoundSample.Core.Dataverse.Account"/> entities.
		/// </summary>
		public System.Linq.IQueryable<MsalUserInteractiveEarlyBoundSample.Core.Dataverse.Account> AccountSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<MsalUserInteractiveEarlyBoundSample.Core.Dataverse.Account>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="MsalUserInteractiveEarlyBoundSample.Core.Dataverse.Role"/> entities.
		/// </summary>
		public System.Linq.IQueryable<MsalUserInteractiveEarlyBoundSample.Core.Dataverse.Role> RoleSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<MsalUserInteractiveEarlyBoundSample.Core.Dataverse.Role>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="MsalUserInteractiveEarlyBoundSample.Core.Dataverse.SystemUser"/> entities.
		/// </summary>
		public System.Linq.IQueryable<MsalUserInteractiveEarlyBoundSample.Core.Dataverse.SystemUser> SystemUserSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<MsalUserInteractiveEarlyBoundSample.Core.Dataverse.SystemUser>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="MsalUserInteractiveEarlyBoundSample.Core.Dataverse.Team"/> entities.
		/// </summary>
		public System.Linq.IQueryable<MsalUserInteractiveEarlyBoundSample.Core.Dataverse.Team> TeamSet
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.CreateQuery<MsalUserInteractiveEarlyBoundSample.Core.Dataverse.Team>();
			}
		}
	}
